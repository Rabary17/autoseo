...
5. Calcule `post_date` selon le système à 3 phases de [wordpress-publication.md](../../skills/wordpress-publication.md) section 6 : **10 pages/jour en phase 0** (homepage/hubs/sous-hubs), **aucune publication en phase 1** (pause indexation), **1 article/jour maximum en phase 2** (rythme de croisière, un seul silo à la fois, palier à augmenter uniquement sur décision explicite de l'utilisateur) — **dimanche exclu** (réservé aux actualités, voir section 6), jamais avant la date de publication de son hub/sous-hub parent, heures réparties dans la journée.
...
7. Termine par un résumé : nombre programmés, nombre bloqués (avec motifs), date du dernier article programmé de la file, et rappelle la conséquence arithmétique du plafond de 1/jour si le volume total dépasse plusieurs mois de file (voir [skills/wordpress-publication.md](../../skills/wordpress-publication.md) section 6).
