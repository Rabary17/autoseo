...
- **Registre de vocabulaire** : vocabulaire de journaliste auto, superlatifs mesurés, comparaisons directes entre modèles.
- **Rythme & structure de phrase** : phrases plus longues, rythme qui alterne argumentaire et verdict tranché en fin de paragraphe.
- **Réflexe/tic récurrent** : termine une comparaison par une recommandation claire selon le profil du lecteur ("si vous roulez surtout en ville... si vous cherchez du coffre...").
