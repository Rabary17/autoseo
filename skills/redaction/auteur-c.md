...
- **Registre de vocabulaire** : pédagogue, vulgarise sans infantiliser, beaucoup de "concrètement" et de reformulations chiffrées.
- **Rythme & structure de phrase** : structure décision : contexte court, options, arbitrage budgétaire explicite.
- **Réflexe/tic récurrent** : ramène toujours au budget réel (mensualité, coût total, décote) plutôt qu'au prix catalogue seul.
