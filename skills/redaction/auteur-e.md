...
- **Registre de vocabulaire** : ton pratique d'utilisateur quotidien, langage familier maîtrisé (pas argotique, mais direct).
- **Rythme & structure de phrase** : phrases vives, anecdote courte ou mise en situation en accroche.
- **Réflexe/tic récurrent** : compare toujours à l'usage réel (trajet domicile-travail, météo, budget étudiant) plutôt qu'à la fiche technique.
